    ...
    return (function e(t, n, r) {
        ...
        14: [function(_dereq_, module, exports) {
            ...
            var FakeNode = {
                ...
                render: function() {
                    invariant(
                    false, '%s elements should not be rendered',
        ...
        18: [function(_dereq_, module, exports) {
            ...
            var Scrolling = {
                ...
                componentWillMount: function() {
                    invariant(
                    this.getScrollBehavior() == null || canUseDOM, 'Cannot use scroll behavior without a DOM');
                },
                ...
                _updateScroll: function(prevState) {
                    ...
                    if (scrollBehavior) scrollBehavior.updateScrollPosition(
        ...
        22: [function(_dereq_, module, exports) {
            ...
            var History = {
                ...
                back: function() {
                    invariant(
                    canUseDOM, 'Cannot use History.back without a DOM');
                ...
                injectParams: function(pattern, params) {
                    ...
                    return pattern.replace(paramInjectMatcher, function(match, paramName) {
                        ...
                        if (paramName.slice(-1) !== '?') {
                            invariant(
                            params[paramName] != null, 'Missing "' + paramName + '" parameter for path "' + pattern + '"');
                        } else {
                        ...
                        if (paramName === 'splat' && Array.isArray(params[paramName])) {
                            ...
                            invariant(
                            segment != null, 'Missing splat # ' + splatIndex + ' for path "' + pattern + '"');
                        } else {
        ...
        28: [function(_dereq_, module, exports) {
            ...
            function createRouter(options) {
                ...
                if (typeof location === 'string') {
                    ...
                    invariant(
                    canUseDOM, 'You cannot use %s without a DOM',
                    location);
                }
                    ...
                    statics: {
                        ...
                        makePath: function(to, params, query) {
                            ...
                            if (Path.isAbsolute(to)) {
                                ...
                                invariant(
                                route, 'Unable to find <Route name="%s">',
                                to);
                        ...
                        transitionTo: function(to, params, query) {
                            invariant(
                            typeof location !== 'string', 'You cannot use transitionTo with a static location');
                        ...
                        replaceWith: function(to, params, query) {
                            invariant(
                            typeof location !== 'string', 'You cannot use replaceWith with a static location');
                        ...
                        goBack: function() {
                            invariant(
                            typeof location !== 'string', 'You cannot use goBack with a static location');
                        ...
                        dispatch: function(path, action, callback) {
                            ...
                            warning(
                            match != null, 'No route matches path "%s". Make sure you have <Route path="%s"> somewhere in your routes',
                            path, path);
            ...
            function createRoute(element, parentRoute, namedRoutes) {
                ...
                if (parentRoute && Array.isArray(parentRoute.paramNames)) {
                    parentRoute.paramNames.forEach(function(paramName) {
                        invariant(
                        route.paramNames.indexOf(paramName) !== -1, 'The nested route path "%s" is missing the "%s" parameter of its parent path "%s"',
                ...
                if (props.name) {
                    invariant(
                    namedRoutes[props.name] == null, 'You cannot use the name "%s" for more than one route',
                    props.name);
                ...
                if (type === NotFoundRoute.type) {
                    invariant(
                    parentRoute, '<NotFoundRoute> must have a parent <Route>');

                    invariant(
                    parentRoute.notFoundRoute == null, 'You may not have more than one <NotFoundRoute> per <Route>');
                ...
                if (type === DefaultRoute.type) {
                    invariant(
                    parentRoute, '<DefaultRoute> must have a parent <Route>');

                    invariant(
                    parentRoute.defaultRoute == null, 'You may not have more than one <DefaultRoute> per <Route>');
        ...
        30: [function(_dereq_, module, exports) {
            ...
            function getWindowScrollPosition() {
                invariant(
                canUseDOM, 'Cannot get current scroll position without a DOM');
